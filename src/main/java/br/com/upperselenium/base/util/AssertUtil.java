...
public class AssertUtil extends Assert{
    ...
    private static void reportEvidenceConditionalAssertion(boolean condition, Object message){    	
		BaseReport.reportConditionalAssertion(condition, message);		
    }

    private static void reportEvidenceSuccessEqualsAssertion(Object expected, Object actual){
    	BaseReport.reportSuccessEqualsAssertion(expected, actual);
    }

    private static void reportEvidenceFailedEqualsAssertion(Object expected, Object actual){
    	BaseReport.reportFailedEqualsAssertion(expected, actual);
    }
    
    private static void reportEvidenceNotEqualsAssertion(Object unexpected, Object actual){
    	BaseReport.reportNotEqualsAssertion(unexpected, actual);
    }
    ...
    static public void assertTrue(String message, boolean condition) {
        if (!condition) {
            fail(message);
            reportEvidenceConditionalAssertion(condition, "");
        }
    }
    ...
    static public void assertFalse(String message, boolean condition) {
        ...
        reportEvidenceConditionalAssertion(condition, message);
    }
    ...
    static public void assertEquals(String message, Object expected,
        ...
        if (equalsRegardingNull(expected, actual)) {
        	reportEvidenceSuccessEqualsAssertion(expected, actual);
            return;
        } else if (expected instanceof String && actual instanceof String) {
            String cleanMessage = message == null ? "" : message;
            reportEvidenceFailedEqualsAssertion(expected, actual);
    ...
    static public void assertNotEquals(String message, Object unexpected,
        ...
        if (equalsRegardingNull(unexpected, actual)) {
            ...
            reportEvidenceNotEqualsAssertion(unexpected, actual);
            ScreenshotEvidencesUtil.takeDetachedScreenshot();
        }
    }
    ...
    private static void failEquals(String message, Object actual) {
        String formatted = "The values should be different from each other! ";
        if (message != null) {
            formatted = message + ". ";
        }
    ...
    static private void failSame(String message) {
        ...
        fail(formatted + "Expected is not the same!");
    }
    ...
    static private void failNotSame(String message, Object expected,
        ...
        fail(formatted + "Expected:<" + expected + "> , but:<" + actual + ">");
    }
    ...
    static String format(String message, Object expected, Object actual) {
        ...
        if (expectedString.equals(actualString)) {
            return formatted + "Expected: "
                    ...
                    + " but found: " + formatClassAndValue(actual, actualString);
        } else {
            return formatted + "Expected:<" + expectedString + "> but:<"
                    + actualString + ">";
        }
    }
